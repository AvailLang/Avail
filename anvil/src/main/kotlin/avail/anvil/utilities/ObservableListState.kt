...
): MutableList<T>
{
	...
	/**
	 * Answer a [ObservableSnapshotStateList] linked to this
	 * [ObservableListState].
	 *
	 * @param changeAction
	 *   An action that accepts the a newly added value to [ObservableListState].
	 * @return
	 *   A new `ObservableSnapshotStateList`.
	 */
	fun snapshotStateList (changeAction: (ListStateChange<T>) -> Unit = {})
		: ObservableSnapshotStateList<T> =
			ObservableSnapshotStateList(this, changeAction)
